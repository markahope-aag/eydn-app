    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://*.clerk.accounts.dev https://*.clerk.com https://clerk.eydn.app https://www.googletagmanager.com https://app.termly.io",
              ...
              "font-src 'self' data:",
              "connect-src 'self' https://pnclblivqpakijkerykn.supabase.co https://*.clerk.accounts.dev https://*.clerk.com https://clerk.eydn.app https://api.stripe.com https://*.upstash.io https://www.googletagmanager.com https://www.google-analytics.com https://app.termly.io",
