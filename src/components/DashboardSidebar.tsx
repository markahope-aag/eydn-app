        ...
        {admin && (
          <div>
            ...
            <div className="flex flex-col gap-0.5 mt-0.5">
              ...
              <NavLink item={{ href: "/dashboard/admin/leads", label: "Leads" }} active={isActive(pathname, "/dashboard/admin/leads")} onClick={() => setOpen(false)} />
            ...
            <div className="flex flex-col gap-0.5 mt-0.5">
              ...
              <NavLink item={{ href: "/dashboard/admin/email-images", label: "Email Images" }} active={isActive(pathname, "/dashboard/admin/email-images")} onClick={() => setOpen(false)} />
