  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        ...
        {unread > 0 && (
          <span
            className="absolute -top-1 -right-1 bg-violet text-white text-[10px] font-semibold rounded-full w-4 h-4 flex items-center justify-center"
            role="status"
            aria-live="polite"
      ...
      {open && (
        <div className="absolute left-0 bottom-full mb-2 w-72 max-w-[calc(100vw-1rem)] max-h-[calc(100vh-2rem)] overflow-y-auto bg-white rounded-[16px] border border-border shadow-lg z-50">
