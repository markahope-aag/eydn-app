...
/**
 * Clerk-free landing-page nav.
 *
 * Identical visual behaviour to LandingNav (scroll-responsive transparency,
 * mobile overlay) minus the `useAuth()` hook — marketing pages skip the Clerk
 * SDK entirely, so signed-in visitors see the "Sign In / Start Free" CTAs
 * instead of "Go to Dashboard". Acceptable tradeoff: the homepage is almost
 * exclusively viewed by signed-out prospects.
 */
const navLinks = [
  ...
  return (
    <>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }} className="max-md:!hidden">
          <Link
            href="/sign-in"
            className="landing-nav-link"
            style={{
