...
export function EmailTemplate({ category, onClose }: Props) {
  ...
  if (!active) {
    return (
      <Modal open onClose={onClose} title="Email Template" size="lg">
  ...
  return (
    <Modal
      open
      onClose={onClose}
      title={`${showFollowUp ? "Follow-Up" : category} Email Template`}
      size="lg"
    >
      <div className="mt-4">
        <p className="text-[12px] font-semibold text-muted uppercase">
          Subject
        </p>
