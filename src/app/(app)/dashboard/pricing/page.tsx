  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-2 md:items-stretch">
        {/* Lifetime — featured */}
        <div className="card-summary relative p-6 sm:p-8 border-2 border-violet md:order-1 order-1 flex flex-col" style={{ overflow: "visible" }}>
          <div
        ...
        {/* Monthly — hedge */}
        <div className="card-summary p-6 sm:p-8 md:order-2 order-2 flex flex-col">
          <div className="text-center">
